        ...
        <table border="1" cellspacing="0" class="table table-bordered text-center">
            ...
            <%
                ...
                for(int i =0; i<listWisata.size(); i++){
                    %>
                    <tr>
                        <td> <%= listWisata.get(i).getId() %> </td>
                        <td> <%= listWisata.get(i).getNama() %> </td>
                        <td> <%= listWisata.get(i).getDeskripsi() %> </td>
                    
                        <td><a href ="hapus_wisata?id=<%= listWisata.get(i).getId() %>">Hapus</a></td>
                        <td><a href ="update_data_wisata.jsp?id=<%= i %>">Edit</a></td>
                    </tr>
                    <%
                }
                %>
        </table>
        <a href ="tambah_wisata_baru.jsp">Tambah</a>
        </div>
        </div>
    </body>
</html>